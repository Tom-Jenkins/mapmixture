...
launch_mapmixture <- function(...) {
  ...
  if (length(missing_packages) > 0) {
    stop(
      ...
      "E.g. to install Shiny version 1.8.0 from source: `install.packages('https://cran.r-project.org/src/contrib/Archive/shiny/shiny_1.8.0.tar.gz', repos = NULL, type = 'source'`)"
    )
  }
